...
volatile uint32_t freq[] = {
	148000000, 148100000, 148200000, 148300000, 148400000, 148500000, 148600000, 148700000, 148800000, 148900000,
	149000000, 149100000, 149200000, 149300000, 149400000, 149500000, 149600000, 149700000, 149800000, 149900000,
	150000000, 150100000, 150200000, 150300000, 150400000, 150500000, 150600000, 150700000, 150800000, 150900000,
	151000000, 151100000, 151200000, 151300000, 151400000, 151500000, 151600000, 151700000, 151800000, 151900000
};
...
{
	FILE * file = fopen("/home/pi/senior_project/config.txt", "r");
	char * str, buffer[255];
	int z;
